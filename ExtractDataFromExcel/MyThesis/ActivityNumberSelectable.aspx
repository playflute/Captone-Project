...
<head>
    ...
    <script src="Javascript/jquery.datetimebox.js"></script>
    ...
    <script type="text/javascript">
        ...
        <script type="text/javascript">
            $(function () {
                $('#dt_picker_start').datetimebox({
                    value: '<%=start_str_for_easyui.ToString()%>',
                    required: true,
                    
                });
                $('#dt_picker_end').datetimebox({
                    value: '<%=end_str_for_easyui.ToString()%>',
                    required: true,
                    
                });
                $('#advance').click(function(){
                    $('#accurate_datetime_picker').show();
                    //$('#accurate_datetime_picker').removeAttr("hidden");
                    $('#control_div').hide();
                    $("#advance").hide();
                    $("#normal").show();
                });
                $("#normal").click(function () {
                    ...
                    $("#advance").show();
                    $("#normal").hide();
                    $("#accurate_datetime_picker").hide();
                    
                });
                $('#btn_query').click(function () {
                    //get start time from datetime box                   
                    var start_datetime = new Date($('#dt_picker_start').datetimebox('getValue'));
                    var start_year = start_datetime.getFullYear();
                    var start_month = start_datetime.getMonth() + 1 < 10 ? "0" + (start_datetime.getMonth() + 1) : start_datetime.getMonth() + 1;
                    var start_date = start_datetime.getDate() < 10 ? "0" + start_datetime.getDate() : start_datetime.getDate();
                    var start_hour = start_datetime.getHours() < 10 ? "0" + start_datetime.getHours() : start_datetime.getHours();
                    ...
                    var start_second = start_datetime.getSeconds() < 10 ? "0" + start_datetime.getSeconds() : start_datetime.getSeconds();
                    var standard_start_time = start_year + "-" + start_month + "-" + start_date + " " + start_hour + ":" + start_minute + ":" + start_second;
                    ///////////////////////////get end time from datetime box
                    var end_datetime = new Date($('#dt_picker_end').datetimebox('getValue'));
                    var end_year = end_datetime.getFullYear();
                    var end_month = end_datetime.getMonth() + 1 < 10 ? "0" + (end_datetime.getMonth() + 1) : end_datetime.getMonth() + 1;
                    var end_date = end_datetime.getDate() < 10 ? "0" + end_datetime.getDate() : end_datetime.getDate();
                    var end_hour = end_datetime.getHours() < 10 ? "0" + end_datetime.getHours() : end_datetime.getHours();
...
<select id="eventsList">  </select>  
    <div id="accurate_datetime_picker"  hidden="hidden">
        Star Datetime
        <input id="dt_picker_start" style="width:140px" type="text" name="picker_start">
        End Datetime
        <input id="dt_picker_end" style="width:140px" type="text" name="picker_end">     
        <button id="btn_query">search</button> 
    </div>
      <button id="advance">Advanced search</button>

        <button id="normal" hidden="hidden">back to drag and drog mode</button>
</body>
</html>
